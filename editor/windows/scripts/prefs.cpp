...
// TorqueScript
const char* TSDeclarations =
"datablock function new singleton";
const char* TSKeywords =
"if then else elseif for foreach foreach$ in while switch switch$ case "
"default break true false";
const char* TSStringCatKeywords =
"SPC TAB NL @";
...
const LanguageInfo g_LanguagePrefs [] = {
    ...
    {"TorqueScript",
     ...
     {{mySTC_TYPE_DEFAULT, NULL},
      {mySTC_TYPE_COMMENT_LINE, NULL},
      {mySTC_TYPE_COMMENT, NULL},
      {mySTC_TYPE_LOCALVAR, NULL},
      {mySTC_TYPE_GLOBALVAR, NULL},
      {mySTC_TYPE_IDENTIFIER, NULL},
      {mySTC_TYPE_STRING, NULL},
      {mySTC_TYPE_CHARACTER, NULL},
      {mySTC_TYPE_NUMBER, NULL},
      {mySTC_TYPE_WORD2, TSKeywords},
      {mySTC_TYPE_WORD1, TSDeclarations},
      {mySTC_TYPE_OPERATOR, TSStringCatKeywords},
      {mySTC_TYPE_OPERATOR, NULL},
      {mySTC_TYPE_DELIMITER, NULL},
      {mySTC_TYPE_ERROR, NULL},
      {-1, NULL},
      {-1, NULL},
      {-1, NULL},
      {-1, NULL},
      ...
      {-1, NULL},
      {-1, NULL}},
      mySTC_FOLD_COMMENT | mySTC_FOLD_COMPACT },
    // Python
    {"Python",
     "*.py;*.pyw",
     wxSTC_LEX_PYTHON,
